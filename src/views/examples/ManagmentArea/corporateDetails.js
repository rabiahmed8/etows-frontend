...
import { singleAllCorporate, singleDeleteCorporate, singleSaveAgency, singleUpdateAgency } from "../../../APIstore/apiCalls";
...
var hoistData = {};
function TowVehicleInventory(props) {
  const { classes } = props;
          ...
          <div className="col">
            <Card className="shadow">
              <CardHeader className="border-0">
                <Row>
                  <h3 className="mb-0">{config.CorporateDetails}</h3>
                        ...
                        return (
                          <tr>
                            <Link
                              ...
                              to={{
                                pathname: "/admin/corp-documents-detail",
...
TowVehicleInventory.propTypes = {
  classes: PropTypes.object.isRequired
};
export default withStyles(styles)(TowVehicleInventory);
