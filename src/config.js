const config = {
  ...
  sRequest:{
    policeService:{label:{"l1":"LE Related *"},checkCond:"indicatePolice:l1"},
    propertyName:{label:{"l1":"Select Vehicle *","l2":"Select Property *"},ext:"Item Type ",checkCond:"vehicleOrProperty:l1"},
    ...
    officerBadge:{label:{"l1":"Officer Badge *"},checkCond:"indicatePolice:l1"},
    officerName:{label:{"l1":"Officer Name *","l2":"Name *"},checkCond:"indicatePolice:l1",cext:"client "},
    officerContact:{label:{"l1":"Officer Contact *","l2":"Phone Number *"},checkCond:"indicatePolice:l1",cext:"client "},
    officerDepart:{label:{"l1":"Officer Unit/Assignment *"},checkCond:"indicatePolice:l1"},
  },
};
